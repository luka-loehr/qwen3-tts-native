...
SOURCE_DATE_EPOCH="$(git show -s --format=%ct HEAD)" \
  ./tools/release-metadata/generate.sh <home>/qwen3-tts-release/metadata
...
RELEASE_VERSION=v0.1.0 ./tools/release-image/build-and-push.sh \
  <artifacts>/qwen3-tts-1.7b-voice-design-bf16-indexed \
  <home>/qwen3-tts-release/metadata \
  <home>/qwen3-tts-release/build

./tools/release-image/verify-supply-chain.sh \
  <home>/qwen3-tts-release/build/release-record.json \
  <home>/qwen3-tts-release/supply-chain
...
./tools/release-image/clean-pull-gpu-acceptance.sh \
  <home>/qwen3-tts-release/build/release-record.json \
  <home>/qwen3-tts-release/build/builder-docker-info.json \
  <home>/qwen3-tts-release/gpu-acceptance
```
...
COSIGN_BIN="$RELEASE_IMAGE_TOOLS_DIR/bin/cosign" \
  ...
  <home>/qwen3-tts-release/build/release-record.json \
  <home>/qwen3-tts-release/supply-chain/supply-chain-verified.json \
  <home>/qwen3-tts-release/gpu-acceptance/gpu-acceptance.json \
  <home>/qwen3-tts-release/promotion
```
