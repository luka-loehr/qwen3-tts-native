...
Only one subject may use CUDA during a run. Subject order alternates between
rounds so persistent host state and thermal drift do not always favor the same
implementation.
