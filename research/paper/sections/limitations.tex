...
run-to-run variation but cannot characterize population-level hardware
variance. The production matrix groups all stock runs before all Native runs
to avoid repeated eviction and loading of the stock working set. Consequently,
the comparison is not order-counterbalanced and may retain persistent
host-state or thermal bias despite idle baselines and one-at-a-time CUDA
isolation.
